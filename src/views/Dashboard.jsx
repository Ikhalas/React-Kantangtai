                    ...
                    <Col md="8" xs="7">
                      <div className="numbers">
                        <p
                          ...
                          className="card-category"
                        >
                          คำขอที่ยังไม่ดำเนินการ
                        </p>
                        <CardTitle tag="p">
                          {this.getTotalYellow()} รายการ
                        </CardTitle>
                        <p />
                      </div>
                    </Col>
                    ...
                    <Col md="8" xs="7">
                      <div className="numbers">
                        <p
                          ...
                          className="card-category"
                        >
                          บัญชีผู้มีสิทธิ์ใช้งานระบบ
                        </p>
                        <CardTitle tag="p">
                          {this.getTotalUser()} บัญชี
                        </CardTitle>
                        <p />
                      </div>
                    </Col>
            ...
            <Col md="12">
              <Card>
                ...
                <CardFooter>
                  ...
                  <hr />
                  <div className="stats">
                    <i className="fa fa-map-marker-alt" /> ตำบลกันตังใต้
