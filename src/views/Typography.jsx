...
class Typography extends React.Component {
  ...
  getData() {
    db.collection("requests")
      ...
      .then(snapshot => {
        ...
        this._isMounted &&
          this.setState({ requests, listToShow: requests, showButton: true });
      })
    ...
    return (
      ...
      listToShow.map(list => (
        <tr key={list.id}>
          ...
          <td>
            {list.address}&nbsp;&nbsp;หมู่ที่&nbsp;{list.moo}&nbsp;&nbsp;
            {list.soi === "" ? null : <span>ซอย{list.soi}</span>}&nbsp;&nbsp;
            {list.road === "" ? null : <span>ถนน{list.road}</span>}
          </td>
          <td>
            {list.status === true ? (
          ...
          <td className="text-right">
            {list.successful === "" ? (
              <span style={{ paddingRight: "90px" }}>-</span>
            ) : (
              <span style={{ paddingRight: "55px" }}>{list.successful}</span>
            )}
          </td>
        </tr>
      ))
  ...
  printPDF = () => {
    ...
    if (reportType === "full")
      subheader = 'รายการคำขอรับน้ำสะอาดเพื่ออุปโภคบริโภค "ทั้งหมด"';
    else if (reportType === "unsuccess")
      subheader =
        'รายการคำขอรับน้ำสะอาดเพื่ออุปโภคบริโภคที่อยู่ในสถานะ "รอดำเนินการ"';
    else if (reportType === "success")
      subheader =
        'รายการคำขอรับน้ำสะอาดเพื่ออุปโภคบริโภคที่อยู่ในสถานะ "ดำเนินการเสร็จสิ้น"';
    ...
    const result = listToShow.map(list => {
      return {
        ...
        ที่อยู่:
          ...
          list.moo +
          " " +
          (list.soi === "" ? "" : "ซอย" + list.soi) +
          " " +
          (list.road === "" ? "" : "ถนน" + list.road),
        สถานะการดำเนินงาน:
          list.status === true ? "ดำเนินการเสร็จสิ้น" : "รอการดำเนินการ",
    ...
    var docDefinition = {
      ...
      footer: {
        columns: [
          {
            text: "องค์การบริหารส่วนตำบลกันตังใต้ อำเภอกันตัง จังหวัดตรัง",
            style: "footer"
          }
        ]
      },
              ...
              <Card>
                  ...
                  <Col md="8">
                    ...
                    >
                      ...
                      <p style={{ fontSize: "17px" }}>
                        *เลือกรายการที่ต้องการจัดทำเอกสาร&nbsp;
                      </p>
                    </div>
                  </Col>
                </Row>
                <CardBody style={{ textAlign: "center" }}>
                  ...
                  {this.state.showButton === true ? (
                    ...
                    >
                      <i
                        className="nc-icon nc-cloud-download-93"
                        style={{ fontSize: "40px" }}
                      ></i>
                      <br />
                      ดาวน์โหลดไฟล์ PDF
